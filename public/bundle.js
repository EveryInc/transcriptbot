...
var ChatBot = /*#__PURE__*/function (_Component) {
  ...
  function ChatBot(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "updateStyle", function (style) {
      _this.setState({
        style: style
      });
    });
    _defineProperty(_assertThisInitialized(_this), "updatePersona", function (persona) {
      _this.setState({
        persona: persona
      });
    });
  ...
  _createClass(ChatBot, [{
    ...
    value: function sendMessage() {
      ...
      this.state.messages.forEach(function (message) {
        transcript += "".concat(message.sender, ": ").concat(message.message, "\n");
      });

      // Determine promptType based on last message
      var promptType = "completion";
      ...
      var response_promise = fetch('/ask-huberman', {
        method: 'POST',
        headers: {
      ...
      response_promise.then(function (res) {
        ...
        try {
          ...
          _this2.setState({
            ...
            _this2.messagesEnd.scrollIntoView({
              behavior: 'smooth'
            });
          });
        } catch (e) {
    ...
    value: function render() {
      ...
      return /*#__PURE__*/react.createElement("div", {
        ...
        return /*#__PURE__*/react.createElement("div", {
          key: index,
          className: "chatbot-message ".concat(message.sender),
          ref: function ref(el) {
            if (index === _this3.state.messages.length - 1 && el) {
              _this3.messagesEnd = el;
              _this3.messagesEnd.scrollIntoView({
                behavior: 'smooth'
              });
            }
          }
...
react_dom.render( /*#__PURE__*/react.createElement(chatbot, null), document.getElementById('root'));
})();
